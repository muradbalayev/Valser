          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 max-w-6xl mx-auto mb-20">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-700 dark:text-gray-300">
                Şirkətimiz müştərilərə fərdi yanaşma və yüksək keyfiyyətli xidmət göstərməyi əsas prinsip olaraq qəbul edir. 
                Peşəkar komandamız müasir tələblərə uyğun həllər təklif edərək, müştərilərimizin biznes fəaliyyətinin 
                effektivliyini və qanuniliyini təmin edir.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Valser MMC olaraq, iş yerlərinin attestasiyası xidmətimiz ilə müəssisənizi qanuni tələblərə uyğunlaşdırır, 
                  işçilərinizin sağlamlığını qoruyur və potensial cərimələrdən yayınmağınıza kömək edirik.
                </p>
              </motion.div>
            </motion.div>
          </AnimatePresence>
